...
in the dataset are at least self-consistent within each sample class (normal,
disease, condition 1 or condition 2).

My go-to for data self-consistency is the correlation heat-map followed by 
principal components analysis (PCA). Correlation heat-maps involve calculating 
